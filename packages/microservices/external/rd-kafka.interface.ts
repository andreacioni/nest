...
export interface ReadStreamOptions extends ReadableOptions {
  topics:
    | SubscribeTopicList
    | SubscribeTopic
    | ((metadata: Metadata) => SubscribeTopicList);
  waitInterval?: number;
  fetchSize?: number;
  objectMode?: boolean;
...
type EventListener<K extends string> = K extends keyof EventListenerMap
  ? EventListenerMap[K]
  : never;
...
> extends EventEmitter {
  ...
  connect(
    ...
    cb?: (err: LibrdKafkaError, data: Metadata) => any,
  ): this;
  ...
  disconnect(
    timeout: number,
    cb?: (err: any, data: ClientMetrics) => any,
  ): this;
  ...
  queryWatermarkOffsets(
    ...
    partition: number,
    timeout: number,
    cb?: (err: LibrdKafkaError, offsets: WatermarkOffsets) => any,
  ): any;
  queryWatermarkOffsets(
    topic: string,
    partition: number,
...
export declare class KafkaConsumer extends Client<KafkaConsumerEvents> {
  ...
  commitSync(
    topicPartition: TopicPartitionOffset | TopicPartitionOffset[],
  ): this;

  committed(
    toppars: TopicPartition[],
    timeout: number,
    cb: (err: LibrdKafkaError, topicPartitions: TopicPartitionOffset[]) => void,
  ): this;
  committed(
    timeout: number,
    cb: (err: LibrdKafkaError, topicPartitions: TopicPartitionOffset[]) => void,
  ...
  consume(
    number: number,
    cb?: (err: LibrdKafkaError, messages: Message[]) => void,
  ): void;
  ...
  seek(
    toppar: TopicPartitionOffset,
    timeout: number | null,
    cb: (err: LibrdKafkaError) => void,
  ): this;
  ...
  offsetsForTimes(
    ...
    timeout: number,
    cb?: (err: LibrdKafkaError, offsets: TopicPartitionOffset[]) => any,
  ): void;
  offsetsForTimes(
    topicPartitions: TopicPartitionTime[],
    cb?: (err: LibrdKafkaError, offsets: TopicPartitionOffset[]) => any,
...
export declare class Producer extends Client<KafkaProducerEvents> {
  constructor(
    conf: ProducerGlobalConfig | ProducerTopicConfig,
  ...
  static createWriteStream(
    ...
    topicConf: ProducerTopicConfig,
    streamOptions: WriteStreamOptions,
  ): ProducerStream;
...
export declare class HighLevelProducer extends Producer {
  produce(
    ...
    key: any,
    timestamp: NumberNullUndefined,
    callback: (err: any, offset?: NumberNullUndefined) => void,
  ): any;
  produce(
    topic: string,
    partition: NumberNullUndefined,
  ...
  setKeySerializer(
    serializer: (key: any, cb: (err: any, key: MessageKey) => void) => void,
  ): void;
  setKeySerializer(
    serializer: (key: any) => MessageKey | Promise<MessageKey>,
  ): void;
  setValueSerializer(
    serializer: (
      value: any,
      cb: (err: any, value: MessageValue) => void,
    ) => void,
  ): void;
  setValueSerializer(
    serializer: (value: any) => MessageValue | Promise<MessageValue>,
  ): void;
}
...
export declare function createReadStream(
  conf: ConsumerGlobalConfig,
  topicConf: ConsumerTopicConfig,
  streamOptions: ReadStreamOptions | number,
): ConsumerStream;
...
export interface IAdminClient {
  ...
  listTopics(
    ...
    cb?: (err: LibrdKafkaError, topics: string[]) => any,
  ): void;

  listGroups(
    cb?: (
      err: LibrdKafkaError,
      result: { groups: GroupOverview[]; errors: LibrdKafkaError[] },
    ) => any,
  ): void;
  listGroups(
    options?: {
  ...
  describeGroups(
    groupIds: string[],
    cb?: (err: LibrdKafkaError, result: GroupDescriptions) => any,
  ): void;
  describeGroups(
    groupIds: string[],
  ...
  deleteGroups(
    groupIds: string[],
    cb?: (err: LibrdKafkaError, result: DeleteGroupsResult[]) => any,
  ): void;
  deleteGroups(
    groupIds: string[],
    options?: { timeout?: number },
